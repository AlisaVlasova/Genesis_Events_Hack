<template>
    <aside class="profile">
            <div class="profile__adaptiv-img">
                <img class="profile__img" src="https://pokemonletsgo.pokemon.com/assets/img/common/char-pikachu.png" alt="photo">
            </div>
                ...
                <p class="profile__text">
                    <a class="profile__link" href="https://telegram.me/LEONID_Schwab">
                        <span class="link__part">
                            <span class="profile__text_grey">Telegram:&nbsp;</span>@LEONID_Schwab
                        </span>
                    </a>
                </p>
                <p class="profile__text">
                    <a class="profile__link" href="tel:+380978551445" style="display: none">
                        <svg class="profile__icon" fill="none" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
